...
<body>
  ...
  <div class="w3-main" style="margin-left:290px;margin-right:-10px;margin-top: -5px;margin-bottom: 0px">
    ...
    <div class="w3-container" style="padding: 50px 200px 20px 200px">
      ...
      <form class="w3-container" action="emp-setsalaryphp.php" method="post">
        ...
        <p>
          <label>Salary</label>
          <input class="w3-input w3-light-grey w3-animate-input" type="number" name="salary">
        </p>
  ...
  <div class="w3-dark-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px">
    <p class="w3-right"><a href="home.php" title="W3.CSS" target="_blank" class="w3-hover-opacity">HOME PAGE</a></p>
  </div>
