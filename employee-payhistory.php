...
<body>
    ...
    <div class="w3-container" style="padding: 50px 200px 20px 200px">
      ...
      <form class="w3-container" action="employee-payhistoryshow.php" method="post">
        ...
        <p>
          ...
          <input class="w3-input w3-light-grey w3-animate-input" type="number" name="id">
        </p>
  ...
  <div class="w3-dark-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px">
    <!-- <p class="w3-right">Reference <a href="https://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank" class="w3-hover-opacity">w3school</a></p> -->
  </div>
